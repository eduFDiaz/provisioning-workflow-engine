...
g = Github("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")

repository = g.get_repo('pal-saurabh/network-workflows')

file_content  = repository.get_contents('/l3vpn-provisioning/vpn_provisioning.yml', ref="main")
